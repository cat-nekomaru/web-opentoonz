...
- Key Learnings
  ...
  - VScode & Live Serverの組み合わせはLAN内でhtml検証にとても便利（例： http://192.168.xx.xx:5050/ で検証デバイスからPCのVScodeにアクセス可能）

- Reflections
  - ＊書きかけ＊
 Markdownにログを残しておけば、全方位に有益なことを察してしまった。これこそソフトウェア開発の基礎ではないだろうか。みたいな。
